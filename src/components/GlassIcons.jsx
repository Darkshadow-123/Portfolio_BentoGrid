...
const GlassIcons = ({ items, className }) => {
  ...
  return (
    <div className={`flex flex-col items-start justify-evenly w-full h-full  ${className || ''}`}>
      {items.map((item, index) => (
        ...
        >
          ...
          <span className="absolute top-full left-0 right-0 text-center whitespace-nowrap leading-[2] text-base opacity-0 text-amber-50 transition-[opacity,transform] duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] translate-y-0 group-hover:opacity-100 group-hover:[transform:translateY(20%)]">
            {item.label}
          </span>
