 ...
 return (
  <div className="flex flex-col h-full w-full items-center justify-center">
      ...
      <div className="flex flex-row h-full w-full">
        ...
        <div className="w-full max-w-3xl mx-auto p-2 mt-10">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_0_30px_rgba(0,0,0,0.4)] overflow-hidden">  
            {/* Playlist Preview */}
                <a
                  ...
                  className="block"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-4 p-4 bg-gradient-to-r from-violet-600/80 to-violet-500/80 hover:from-violet-600 hover:to-violet-500 transition-all duration-300 cursor-pointer">
                    
                    {/* Cover */}
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-xl overflow-hidden bg-black flex-shrink-0">
                      <img
